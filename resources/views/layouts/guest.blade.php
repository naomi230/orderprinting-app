...
label.checkbox :checked + span:after {
  ...
  color: #cda45e;
    ...
    <body style="background:rgba(25,25,25,0.96); color:white;">

      <header id="header" class="d-flex align-items-center" style="background: rgba(25, 25, 25, 0.92); display:flex; justify-content:flex-end;">
